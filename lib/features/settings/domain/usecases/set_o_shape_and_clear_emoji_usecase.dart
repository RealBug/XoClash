...
class SetOShapeAndClearEmojiUseCase {

  SetOShapeAndClearEmojiUseCase(this._repository);
  final SettingsRepository _repository;

  Future<void> execute(String shape) async {
    final Settings currentSettings = await _repository.getSettings();
    final Settings updatedSettings = currentSettings.copyWith(oShape: shape, oEmoji: null);
